...
// clients
* GET /client?index=0&amount=45
* GET /client/id:{id}
* GET /client/pay_to:{wallet_id}
* GET /client/host:{host_id}
* POST /client
* PUT /client/{id}
* DELETE /client/{id}

// client requests
* GET /client/id:{id}/requests
* POST /client/id:{id}/request/id:{request_id}
* PUT /client/id:{id}/request/id:{request_id}
* DELETE /client/id:{id}/request/id:{request_id}

// customer:
* GET /customers?index=0&amount=45
* GET /customers/id:{id}
* GET /customers/id:{id}/reports
* GET /customers/transfer_id:{transfer_id}
* GET /customers/report_id:{report_id}?index=0&amount=45
* POST /customers
* PUT /customers/id:{id}

// host
* GET /hosts?index=0&amount=45
* GET /hosts/id:{id}
* GET /hosts/ip:{ip}?index=0&amount=45
* GET /hosts/country_id:{country_id}?index=0&amount=45
* GET /hosts/region_id:{region_id}?index=0&amount=45
* GET /hosts/city_id:{city_id}?index=0&amount=45
* GET /hosts/organization_id:{organization_id}?index=0&amount=45
* GET /hosts/latitude:{lat}-longitude:{long}-radius:{radius}?index=0&amount=45

// host country:
* GET /hosts/countries?index=0&amount=45
* GET /hosts/countries/id:{id}

// host region:
* GET /hosts/regions?index=0&amount=45
* GET /hosts/regions/id:{id}
* GET /hosts/regions/country_id:{country_id}?index=0&amount=45

// host cities:
* GET /hosts/cities?index=0&amount=45
* GET /hosts/cities/id:{id}
* GET /hosts/cities/country_id:{country_id}?index=0&amount=45
* GET /hosts/cities/region_id:{region_id}?index=0&amount=45
...
### Application GUI
This section will show how to use the application for each entity type (client, customer and server).
